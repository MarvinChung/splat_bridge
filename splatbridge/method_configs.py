...
from splatbridge.ros_datamanager import (
    ROSDataManagerConfig,
    ROSDataManager,
    ROSFullImageDataManagerConfig,
    ROSFullImageDataManager,
)
from splatbridge.ros_dataparser import ROSDataParserConfig
from splatbridge.ros_trainer import ROSTrainerConfig
from splatbridge.ros_dataset import ROSDataset, ROSDepthDataset
from splatbridge.ros_splatfacto import ROSSplatfactoModelConfig
...
RosNerfacto = MethodSpecification(
    ...
    description="Run SplatBridge with the Nerfacto model, and train with streamed RGB images.",
)
...
RosDepthNerfacto = MethodSpecification(
    ...
    description="Run SplatBridge with the DepthNerfacto model, and train with streamed RGB and depth images.",
)
...
RosSplatfacto = MethodSpecification(
    ...
    description="Run SplatBridge with the Splatfacto model, and train with streamed RGB images.",
)
...
RosDepthSplatfacto = MethodSpecification(
    ...
    description="Run SplatBridge with the Splatfacto model, and train with streamed RGB and depth images used to seed new gaussains.",
)
